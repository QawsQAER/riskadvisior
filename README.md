...
The current url is [riskadvisor.mybluemix.net](http://riskadvisor.mybluemix.net/).

## TODO
* rename the "webcrawler" in dir, package name to "riskadvisor"
* add intro to tradeoff Analysis in READMD.md
...
* From Jazz Hub (This is possibily the oldest version of src code)
...
* Tomcat configurations
  ...
  * Add this line into the <host> tag.
  ```
  <Context docBase="your_workspace/webcrawler/webStarterApp.war" path="/" reloadable="true"/>
  ```
...
We recommend [Eclipse EE](http://www.eclipse.org/downloads/packages/eclipse-ide-java-ee-developers/keplersr2) as the IDE for this project.
    ...
    "records": [
        {
            ...
            "url" : "http://dummy/doc.html",
            "SIC" : "0000",
            "SICName" : "Computer Industry",
            "document" : "10-K", //10-K, 20-F, 8-K e.t.c
            "wordCount" : 9000
        }
    ]
}
...
We use [Jersey](https://jersey.java.net/) to build the restful APIs.
