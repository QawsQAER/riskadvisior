...
# from /System/Library/Frameworks/Python.framework/Versions/2.7/Extras/lib/python/scipy/stats/mvn.so
# by generator 1.136
"""
...
dkblck = None # (!) real value is ''

mvndst = None # (!) real value is ''

mvnun = None # (!) real value is ''
