...
# from /System/Library/Frameworks/Python.framework/Versions/2.7/Extras/lib/python/scipy/interpolate/dfitpack.so
# by generator 1.136
"""
...
regrid_smth_spher = None # (!) real value is ''

spalde = None # (!) real value is ''

spherfit_lsq = None # (!) real value is ''

spherfit_smth = None # (!) real value is ''
