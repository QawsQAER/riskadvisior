...
# from /System/Library/Frameworks/Python.framework/Versions/2.7/Extras/lib/python/scipy/sparse/linalg/isolve/_iterative.so
# by generator 1.136
"""
...
cbicgrevcom = None # (!) real value is ''

cbicgstabrevcom = None # (!) real value is ''

ccgrevcom = None # (!) real value is ''

ccgsrevcom = None # (!) real value is ''

cgmresrevcom = None # (!) real value is ''

cqmrrevcom = None # (!) real value is ''

cstoptest2 = None # (!) real value is ''

dbicgrevcom = None # (!) real value is ''

dbicgstabrevcom = None # (!) real value is ''

dcgrevcom = None # (!) real value is ''

dcgsrevcom = None # (!) real value is ''

dgmresrevcom = None # (!) real value is ''

dqmrrevcom = None # (!) real value is ''

dstoptest2 = None # (!) real value is ''

sbicgrevcom = None # (!) real value is ''

sbicgstabrevcom = None # (!) real value is ''

scgrevcom = None # (!) real value is ''

scgsrevcom = None # (!) real value is ''

sgmresrevcom = None # (!) real value is ''

sqmrrevcom = None # (!) real value is ''

sstoptest2 = None # (!) real value is ''

zbicgrevcom = None # (!) real value is ''

zbicgstabrevcom = None # (!) real value is ''

zcgrevcom = None # (!) real value is ''

zcgsrevcom = None # (!) real value is ''

zgmresrevcom = None # (!) real value is ''

zqmrrevcom = None # (!) real value is ''

zstoptest2 = None # (!) real value is ''
