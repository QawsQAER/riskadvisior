<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <head>
        <link rel="stylesheet" href="watson-bootstrap-dark.css">
        ...
        <%@ include file="./templates/header.jsp" %>
            ...
            <div class="container">
                <div>
                    ...
                    <button type="submit" id="analyze" class="btn btn-primary">Analyze</button>
                    <br>
                </div>
                <div class="row viz result">
                    ...
                    <div style="display: none; margin-bottom: 30px" class="col-lg-12 col-xs-12 decisionArea">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('#appendComp').click(function() {
                        var json = JSON.parse($('#companies').val());
                        json.companies.push($('#inputCompany').val());
                        $('#companies').val(JSON.stringify(json));
                    ...
                    $('#potentialLawsuits').multiselect({
                        ...
                        onDropdownHide: function(options, select) {
                            ...
                            var newKeyword = {
                                "category": "Potential/Ongoing Lawsuits",
                                "factors": []
                            };
                            selectedOptions.each(function() {
                                newKeyword.factors.push($(this).val());
                    ...
                    $('#volatileDemandFinancialResults').multiselect({
                        ...
                        onDropdownHide: function(options, select) {
                            ...
                            var newKeyword = {
                                "category": "Volatile demand and financial results",
                                "factors": []
                            };
                            selectedOptions.each(function() {
                                newKeyword.factors.push($(this).val());
                    ...
                    $('#volatileRisks').multiselect({
                        ...
                        onDropdownHide: function(options, select) {
                            ...
                            var newKeyword = {
                                "category": "Volatile stock price risks",
                                "factors": []
                            };
                            selectedOptions.each(function() {
                                newKeyword.factors.push($(this).val());
                    ...
                    $('#poorConditionRisks').multiselect({
                        ...
                        onDropdownHide: function(options, select) {
                            ...
                            var newKeyword = {
                                "category": "Poor financial condition risks",
                                "factors": []
                            };
                            selectedOptions.each(function() {
                                newKeyword.factors.push($(this).val());
                    ...
                    $('#mergerRisks').multiselect({
                        ...
                        onDropdownHide: function(options, select) {
                            ...
                            var newKeyword = {
                                "category": "Merger and Acquisition risks",
                                "factors": []
                            };
                            selectedOptions.each(function() {
                                newKeyword.factors.push($(this).val());
                    ...
                    $('#newProductRisks').multiselect({
                        ...
                        onDropdownHide: function(options, select) {
                            ...
                            var newKeyword = {
                                "category": "New product introduction risks",
                                "factors": []
                            };
                            selectedOptions.each(function() {
                                newKeyword.factors.push($(this).val());
                    ...
                    $('#potentialProducts').multiselect({
                        ...
                        onDropdownHide: function(options, select) {
                            ...
                            var newKeyword = {
                                "category": "Potential defects in products",
                                "factors": []
                            };
                            selectedOptions.each(function() {
                                newKeyword.factors.push($(this).val());
                    ...
                    $('#intellectualRisks').multiselect({
                        ...
                        onDropdownHide: function(options, select) {
                            ...
                            var newKeyword = {
                                "category": "Intellectual Property Risks",
                                "factors": []
                            };
                            selectedOptions.each(function() {
                                newKeyword.factors.push($(this).val());
                ...
                $('#analyze').click(function() {
                    ...
                    var json = {
                        "companies": json1.companies,
                        "keywords": json2.keywords,
                        "year": "2014"
                    };
